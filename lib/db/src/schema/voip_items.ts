...
export const insertVoipItemSchema = createInsertSchema(voipItemsTable).omit({ id: true, createdAt: true });
export type InsertVoipItem = z.infer<typeof insertVoipItemSchema>;
